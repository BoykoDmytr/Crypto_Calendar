...
export async function fetchTournaments() {
  let q = supaRoma
    .from('tournaments')
    .select(
      'id, venue, market, kind, mechanic, coin_symbol, coin_icon, title, page_url, reward_pool, reward_currency, fee_per_1k, fee_auto, fee_auto_lo, fee_auto_hi, fee_auto_note, start_at, end_at, status, approved, config, ' +

  ...
  return (
    <div className="space-y-4">
      <header className="space-y-1">
        <h1 className="text-xl font-semibold">Завершені турніри</h1>
        <p className="text-sm text-gray-500 dark:text-gray-400">Price Reaction для Binance Tournaments (TS Bybit)</p>
      </header>
